...
export function AuthProvider({ children }) {
  ...
  const initialize = useCallback(async () => {
    try {
      ...
      if (accessToken && isValidToken(accessToken)) {
        ...
        enqueueSnackbar(SnackbarMessage.error.tokenNotFound, { variant: SnackbarType.error });
  ...
  }, [storageAvailable, enqueueSnackbar]);
  ...
  const login = useCallback(
    async (username, password) => {
      ...
      if (response.data.success) {
        ...
        setSession(accessToken);
        enqueueSnackbar(SnackbarMessage.success.login, { variant: SnackbarType.success });
        ...
        enqueueSnackbar(SnackbarMessage.error.login, { variant: SnackbarType.error });
      }
    },
    [enqueueSnackbar]
  );
